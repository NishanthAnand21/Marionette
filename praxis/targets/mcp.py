...
SDK so that Praxis stays dependency-light and can talk to a deliberately
...
_EOF_GRACE = float(os.environ.get("PRAXIS_EOF_GRACE", "0.5"))
_SIGNAL_GRACE = float(os.environ.get("PRAXIS_SIGNAL_GRACE", "2.0"))
...
class MCPTarget(MCPClient):
    ...
    def _connect_once(self) -> None:
        ...
        self._stderr_buf = []
        self._threads = [
            self._spawn(self._drain_stdout, "praxis-mcp-stdout"),
            self._spawn(self._drain_stderr, "praxis-mcp-stderr"),
        ]
    ...
    def _request(self, method: str, params: dict[str, Any]) -> Any:
        with self._lock:
            ...
            req_id = f"prx-{secrets.token_hex(8)}"
